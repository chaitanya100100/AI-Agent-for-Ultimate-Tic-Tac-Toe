...
from rishabh import pplayer
from jga import Player13
...
class Manual_Player:
	...
	def move(self, board, old_move, flag):
		...
		mvp = raw_input()
		mvp = mvp.split()
		return (int(mvp[0])*4+int(mvp[2]), int(mvp[1])*4+int(mvp[3]))
...
if __name__ == '__main__':
	...
	if len(sys.argv) != 2:
		...
		print '                8 => My vs. Daksh'
		print '                9 => My vs. Tirth'
		print '                10 => My vs. Rishabh'
		print '                11 => My vs. JG'
		print '                12 => My vs. Anshul'
		sys.exit(1)
